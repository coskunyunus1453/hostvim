...
| 1.3 | **PHP-FPM havuzları** | Sürüm başına pool, kullanıcı/`open_basedir`, `pm` limitleri, panelden sürüm değişince pool güncelleme *(engine: `php_fpm_manage_pools`, site meta `.panelze/site.json`, PHP değişiminde eski pool silinir)* |
