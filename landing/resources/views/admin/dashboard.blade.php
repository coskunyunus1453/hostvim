        ...
        <div class="grid gap-6 xl:grid-cols-3">
            ...
            <div class="admin-card border-slate-200/80 p-6 dark:border-slate-800 xl:col-span-1">
                ...
                <ul class="mt-4 space-y-2 text-sm">
                    <li><a href="{{ route('admin.appearance.index') }}" class="flex items-center justify-between rounded-xl border border-transparent px-3 py-2 hover:border-slate-200 hover:bg-slate-50 dark:hover:border-slate-700 dark:hover:bg-slate-900/50"><span>Görünüm (site + tema + ana sayfa)</span><span class="text-slate-400">→</span></a></li>
