    ...
    <div class="relative z-10 flex min-h-screen">
        <aside class="hidden w-64 flex-col border-r border-slate-200/90 bg-white/95 backdrop-blur-xl dark:border-slate-800/80 dark:bg-slate-950/95 lg:flex">
            ...
            <nav class="flex-1 space-y-1 p-3 text-sm">
                ...
                <a href="{{ route('admin.panel-releases.index') }}" class="flex items-center gap-2 rounded-xl px-3 py-2 {{ request()->routeIs('admin.panel-releases.*') ? 'bg-orange-500/15 font-medium text-orange-800 ring-1 ring-orange-500/30 dark:text-orange-200' : 'text-slate-600 hover:bg-slate-100 dark:text-slate-300 dark:hover:bg-slate-900/80' }}">
                    Panel sürümleri
                </a>
    ...
    <aside x-data="{ open: false }"
        ...
        <div class="absolute inset-y-0 left-0 w-full max-w-xs border-r border-slate-200/90 bg-white shadow-2xl dark:border-slate-800/80 dark:bg-slate-950/98"
            ...
            <nav class="space-y-1 p-3 text-sm">
                ...
                <a href="{{ route('admin.integrations-settings.edit') }}" class="block rounded-xl px-3 py-2 text-slate-700 hover:bg-orange-50 dark:text-slate-200 dark:hover:bg-slate-900/80">Panel entegrasyonları</a>
                <a href="{{ route('admin.appearance.index') }}" class="block rounded-xl px-3 py-2 text-slate-700 hover:bg-orange-50 dark:text-slate-200 dark:hover:bg-slate-900/80">Görünüm</a>
