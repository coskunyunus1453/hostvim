...
return [
    ...
    'updates' => [
        'hub_url' => rtrim(trim((string) env(
            ...
            env('PANELZE_UPDATE_HUB_URL', env('LICENSE_SERVER_URL', env('PANELZE_LICENSE_HUB_URL', env('PANELZE_LICENSE_HUB_URL', 'https://panelze.com'))))
        )), '/'),
        'api_secret' => trim((string) env(
            'PANELZE_PANEL_UPDATES_API_SECRET',
            env('PANELZE_PANEL_UPDATES_API_SECRET', env('PANELZE_LICENSE_API_SECRET', env('PANELZE_LICENSE_API_SECRET', '')))
        )),
    ...
    'license_server' => rtrim(trim((string) env(
        'LICENSE_SERVER_URL',
        env('PANELZE_LICENSE_HUB_URL', env('PANELZE_LICENSE_HUB_URL', 'https://panelze.com'))
    )), '/'),
    ...
    'license_server_api_secret' => trim((string) env(
        ...
        env('PANELZE_LICENSE_API_SECRET', env('PANELZE_LICENSE_API_SECRET', ''))
    )),
    ...
    'license' => [
        ...
        'public_key' => trim((string) env(
            ...
            'tiv72XAtO2krha6GBWryaXo+WGscEEbnbpo283xnLg8='
        )),
    ...
    'stack_install_script' => env('PANELZE_STACK_INSTALL_SCRIPT', '/usr/local/sbin/panelze-stack-install'),
    'stack_install_timeout' => max(300, (int) env('PANELZE_STACK_INSTALL_TIMEOUT', 1800)),
    'stack_install_expected_seconds' => max(60, (int) env('PANELZE_STACK_INSTALL_EXPECTED_SEC', 300)),
