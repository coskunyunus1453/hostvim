...
class DomainOlsVhostController extends Controller
{
    ...
    public function show(Request $request, Domain $domain): JsonResponse
    {
        ...
        $res = $this->engine->getSiteOlsVhost($domain->name);
        if (! empty($res['error'])) {
    ...
    public function update(Request $request, Domain $domain): JsonResponse
    {
        ...
        $res = $this->engine->updateSiteOlsVhost($domain->name, (string) $validated['content']);
        if (! empty($res['error'])) {
            return response()->json([
                'message' => (string) $res['error'],
                'path' => $res['path'] ?? null,
    ...
    public function revert(Request $request, Domain $domain): JsonResponse
    {
        ...
        $res = $this->engine->revertSiteOlsVhost($domain->name);
        if (! empty($res['error'])) {
            return response()->json([
                'message' => (string) $res['error'],
                'path' => $res['path'] ?? null,
