...
return [
    ...
    'import_started' => 'İçe aktarma kuyruğa alındı. İlerleme çubuğundan takip edebilirsiniz.',
    'import_already_running' => 'Bu veritabanı için zaten devam eden bir içe aktarma var.',
    'import_phase_validating' => 'Dosya doğrulanıyor…',
    'import_phase_recreating' => 'Veritabanı sıfırlanıyor…',
    'import_phase_importing' => 'SQL yedek uygulanıyor…',
    'import_phase_finalizing' => 'Boyut güncelleniyor…',
    ...
    'server_mysql_ssh_secret' => 'SSH ile (root): aynı şifre kurulum betiğinin kaydettiği dosyada da yer alır — /root/panelze-mysql-provision.secret',
