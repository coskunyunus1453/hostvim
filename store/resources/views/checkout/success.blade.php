...
<section class="py-20 text-center">
    <div class="mx-auto max-w-lg px-4">
        ...
        <h1 class="mt-6 text-3xl font-bold text-hv-text">Teşekkürler!</h1>
        <p class="mt-4 text-hv-muted">Siparişiniz alındı. Sipariş numaranız: <strong>{{ $order->order_number }}</strong></p>
