...
<section class="py-20 text-center">
    <div class="mx-auto max-w-lg px-4">
        ...
        <h1 class="mt-6 text-3xl font-bold text-stone-900">Ödeme Tamamlanamadı</h1>
        <p class="mt-4 text-stone-600">Sipariş: {{ $order->order_number }}. Lütfen tekrar deneyin veya destek ile iletişime geçin.</p>
