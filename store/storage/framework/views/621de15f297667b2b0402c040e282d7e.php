<div id="mobile-sidebar" class="hv-sidebar lg:hidden" aria-hidden="true">
    ...
    <aside id="mobile-sidebar-panel" class="hv-sidebar-panel" role="dialog" aria-modal="true" aria-label="Navigasyon menüsü">
        <div class="flex items-center justify-between border-b border-hv-border px-5 py-4">
            <?php echo $__env->make('partials.site-logo', ['height' => $siteLogoMobileHeight ?? 36, 'nameClass' => 'text-lg'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        ...
        <nav class="hv-sidebar-nav" aria-label="Mobil menü">
            <a href="<?php echo e(route('home')); ?>" class="hv-sidebar-link <?php echo e(request()->routeIs('home') ? 'hv-sidebar-link-active' : ''); ?>">
            ...
            <details class="hv-sidebar-group">
                ...
                <div class="hv-sidebar-sub">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $navCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <a href="<?php echo e(route('products.category', $cat->slug)); ?>" class="hv-sidebar-sublink <?php echo e(request()->is('urunler/' . $cat->slug) ? 'hv-sidebar-sublink-active' : ''); ?>">
                            <?php echo e($cat->name); ?>

                        </a>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                    <a href="<?php echo e(route('products.index')); ?>" class="hv-sidebar-sublink font-semibold text-hv-secondary">
                        Tüm Paketler →
                    </a>
                </div>
            </details>

            <a href="<?php echo e(route('domain.index')); ?>" class="hv-sidebar-link <?php echo e(request()->routeIs('domain.*') ? 'hv-sidebar-link-active' : ''); ?>">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()?->is_admin): ?>
                <a href="<?php echo e(url('/admin')); ?>" class="hv-sidebar-link">
            ...
            <?php elseif($isCustomerLoggedIn ?? false): ?>
                <a href="<?php echo e($accountUrl ?? route('account.dashboard')); ?>" class="hv-sidebar-link <?php echo e(request()->routeIs('account.*') ? 'hv-sidebar-link-active' : ''); ?>">
                    <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/></svg>
                    Hesabım
                </a>
            <?php else: ?>
                <a href="<?php echo e(route('login')); ?>" class="hv-sidebar-link <?php echo e(request()->routeIs('login') ? 'hv-sidebar-link-active' : ''); ?>">
                ...
                <a href="<?php echo e(route('register')); ?>" class="hv-sidebar-link <?php echo e(request()->routeIs('register') ? 'hv-sidebar-link-active' : ''); ?>">
            ...
            <a href="<?php echo e(route('blog.index')); ?>" class="hv-sidebar-link <?php echo e(request()->routeIs('blog.*') ? 'hv-sidebar-link-active' : ''); ?>">
            ...
            <a href="<?php echo e(route('contact.index')); ?>" class="hv-sidebar-link <?php echo e(request()->routeIs('contact.*') ? 'hv-sidebar-link-active' : ''); ?>">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($headerMenu): ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $headerMenu->activeRootItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item->isDropdown() && $item->activeChildren->isNotEmpty()): ?>
                        <details class="hv-sidebar-group">
                            <summary class="hv-sidebar-link hv-sidebar-summary">
                                <span class="flex items-center gap-3">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item->icon): ?>
                                        <?php echo $__env->make('partials.nav-icon', ['icon' => $item->icon, 'class' => 'h-5 w-5'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                    <?php else: ?>
                            ...
                            <div class="hv-sidebar-sub">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $item->activeChildren; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <a href="<?php echo e($child->href); ?>" class="hv-sidebar-sublink" target="<?php echo e($child->safe_target); ?>" <?php if($child->safe_target === '_blank'): ?> rel="noopener noreferrer" <?php endif; ?>>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($child->icon): ?><?php echo $__env->make('partials.nav-icon', ['icon' => $child->icon, 'class' => 'h-4 w-4 inline-block mr-2 align-middle'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <?php else: ?>
                        <a href="<?php echo e($item->href); ?>" class="hv-sidebar-link" target="<?php echo e($item->safe_target); ?>" <?php if($item->safe_target === '_blank'): ?> rel="noopener noreferrer" <?php endif; ?>>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item->icon): ?>
                                <?php echo $__env->make('partials.nav-icon', ['icon' => $item->icon, 'class' => 'h-5 w-5'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            <?php else: ?>
        ...
        <div class="mt-auto border-t border-hv-border p-5">
            <a href="<?php echo e(route('products.index')); ?>" class="btn-primary w-full justify-center">Paketleri İncele</a>
            <a href="<?php echo e(route('cart.index')); ?>" class="mt-3 flex items-center justify-center gap-2 rounded-xl border border-hv-border px-4 py-3 text-sm font-semibold text-hv-text transition hover:bg-hv-surface">
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/hostvim/store/resources/views/partials/mobile-sidebar.blade.php ENDPATH**/ ?>